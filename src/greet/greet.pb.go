...
func (x *DeadlineRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
func (x *DeadlineResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x3e, 0x0a, 0x0f, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65,
	...
	0x74, 0x69, 0x6e, 0x67, 0x22, 0x2a, 0x0a, 0x10, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x32, 0xec, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x12, 0x3d, 0x0a, 0x08, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x16, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x61,
...
var file_proto_greet_proto_goTypes = []interface{}{
	...
	(*DeadlineRequest)(nil),        // 9: greet.DeadlineRequest
	(*DeadlineResponse)(nil),       // 10: greet.DeadlineResponse
}
var file_proto_greet_proto_depIdxs = []int32{
	...
	0,  // 4: greet.DeadlineRequest.greeting:type_name -> greet.Greeting
	...
	9,  // 9: greet.GreetService.Deadline:input_type -> greet.DeadlineRequest
	...
	10, // 14: greet.GreetService.Deadline:output_type -> greet.DeadlineResponse
...
func (c *greetServiceClient) Deadline(ctx context.Context, in *DeadlineRequest, opts ...grpc.CallOption) (*DeadlineResponse, error) {
	out := new(DeadlineResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/Deadline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreetServiceServer) Deadline(context.Context, *DeadlineRequest) (*DeadlineResponse, error) {
...
func _GreetService_Deadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeadlineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).Deadline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/Deadline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Deadline(ctx, req.(*DeadlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Deadline",
			Handler:    _GreetService_Deadline_Handler,
		},
	},
